...
const Main = ({todos, onDelete, onToggleComplete, renderCompleted, renderActive, onCompletedFiltration, onActiveFiltration, renderAll}) => {
  return (
...
Main.defaultProps = {
  todos: [{ task: 'Create ur first task',
    isCompleted: false,
    date: Date.now(),
    id: 0,}],
  onDelete: ()=>{},
